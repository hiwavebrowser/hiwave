...
2. **Line Range Hotspots**
   ...
   - Files: `parity-baseline/captures/css-selectors.ppm`, `parity-baseline/captures/form-elements.ppm`, `parity-baseline/captures/sticky-scroll.ppm`, `parity-baseline/baseline_report.json`
